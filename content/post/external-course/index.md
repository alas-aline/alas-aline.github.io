...
![Вопрос 4.1.1](image/3.1.PNG){#fig:001 width=70%}

Отмечены основные условия для криптографической хэш-функции (рис. [-@fig:002]).

![Вопрос 4.1.2](image/3.2.PNG){#fig:002 width=70%}

Отмечены алгоритмы цифровой подписи (рис. [-@fig:003]).

![Вопрос 4.1.3](image/3.3.PNG){#fig:003 width=70%}
...
![Вопрос 4.4.1](image/3.14.PNG){#fig:014 width=70%}
...
![Вопрос 4.4.2](image/3.15.PNG){#fig:015 width=70%}

Ответ - цифровая подпись (рис. [-@fig:016]).

![Вопрос 4.4.3](image/3.16.PNG){#fig:016 width=70%}
